...
// Apabila user sudah login dengan benar, maka terbentuklah session
  ...
  $aksi = "modul/mod_laporanharian/aksi_laporanbulanan.php";
...
WHERE c.nama_pegawai=a.id AND c.uraian_kegiatan=b.id ORDER BY c.id ASC";
	...
	<section class="content-header">
		...
		<ol class="breadcrumb">
            ...
            <li><a class="btn btn-danger" href="<?php echo $base_url."modul/mod_laporanbulanan/excel.php?leveluser=$level"; ?>"><i class="fa fa-download"></i></a></li>
        </ol>
	</section>
	<div id='div1'>
				...
				<font size="-1">
				  ...
				  <caption>
				  <h4><center><b>LAPORAN KINERJA BULANAN</b></center></h4>
