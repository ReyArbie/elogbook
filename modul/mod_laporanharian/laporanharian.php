...
<div class="box">
                ...
                <form method="POST"  class="form-horizontal">
					...
					if ($_SESSION['leveluser']=='admin'){
						$query="SELECT a.nip,b.uraian,c.id,c.nama_pegawai,c.foto,c.dokumen
						FROM pegawai a, kegiatan b, kinerja c
						WHERE c.nama_pegawai=a.nama AND c.uraian_kegiatan=b.id ORDER BY c.id ASC";
					}else{
						session_start();
						$query  = "SELECT b.nama_pegawai,a.uraian,b.waktu,b.waktu_selesai,b.id,b.foto,b.dokumen
				...
				<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-sm-6">
								<input type="date" class="form-control" id="tgl_selesaix" name="waktu" />
							</div>
						</div>
...
WHERE c.nama_pegawai=a.id AND c.uraian_kegiatan=b.id ORDER BY c.id ASC";
	...
	<div id='div1'>
				...
				<font size="-1">
				  ...
				  <h6><left><b>NIP <?php echo "$r[nip]"?></b></left></h6>
				  ...
				  <br>	
					...
					$string="SELECT a.nama,b.uraian,c.waktu,c.waktu_selesai,c.id,b.jabatan,c.foto,c.dokumen
FROM pegawai a, kegiatan b, kinerja c
WHERE c.nama_pegawai=a.nama and c.uraian_kegiatan=b.id order by c.id ASC";
					...
					<td width="50%">
					Bandung,&nbsp;&nbsp;&nbsp; <?php  echo tgl_indo($_POST['tgl_mulai']);?><br>
					Pengelola<br>
					<br>
					<br>
					<br>
